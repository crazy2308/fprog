...
class Waiter: # Classe que define o robo, a bateria, e os movimentos do robo
    ...
    def go_to_table_tier3(self, click_point, mesas): # Tier 3: Movimento com verificação de colisões, obstáculos e interação com mesas à escolha de ordem, não completo
        ponto1 = Point(97.0, 135.0)  # Docking station
